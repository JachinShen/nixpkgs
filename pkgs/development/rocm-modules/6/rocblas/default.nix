...
stdenv.mkDerivation (finalAttrs: {
  ...
  cmakeFlags = [
    (lib.cmakeFeature "CMAKE_C_COMPILER" "${clr}/bin/hipcc")
    (lib.cmakeFeature "CMAKE_CXX_COMPILER" "${clr}/bin/hipcc")
    ...
    (lib.cmakeBool "BUILD_WITH_HIPBLASLT" false)
    ...
    (lib.cmakeFeature "ROCM_PLATFORM_VERSION" finalAttrs.version)
  ] ++ lib.optionals buildTensile [
